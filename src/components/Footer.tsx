            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="flex w-full md:w-auto gap-2">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-eagle-gold to-eagle-yellow text-eagle-black font-semibold px-6 py-3 rounded-full text-sm hover:shadow-lg hover:shadow-eagle-gold/30 transition-all duration-300 hover:scale-105 flex items-center gap-2 whitespace-nowrap disabled:opacity-50"
                >
                  {isSubmitting ? <Loader2 size={14} className="animate-spin" /> : (subscribed ? "Inscrit !" : <><Send size={14} /> S&apos;inscrire</>)}
                </button>
              </form>
          </div>
        </div>
